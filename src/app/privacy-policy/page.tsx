  ...
  return (
    <div className="bg-brand-charcoal flex-1">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-brand-grey rounded-xl border border-brand-charcoal p-8 max-w-4xl mx-auto">
          <div className="prose prose-invert max-w-none">
            <p className="text-lg text-brand-white/90 mb-6">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-brand-white/90 mb-4 space-y-2">
                <li>
