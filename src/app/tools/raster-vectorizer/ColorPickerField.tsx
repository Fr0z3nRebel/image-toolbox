    ...
    <div className="space-y-1">
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          placeholder="#000000"
          disabled={disabled}
          className="flex-1 min-w-0 px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white focus:ring-2 focus:ring-teal-500 focus:border-transparent disabled:opacity-50"
        />
      </div>
