export default function HelpContent() {
  return (
    <div className="bg-brand-grey rounded-xl border border-brand-charcoal p-6 space-y-10">
      <section>
        <h2 className="text-lg font-semibold text-brand-white mb-2">
          What is an SVG file?
        </h2>
        <p className="text-brand-white/90 text-sm leading-relaxed mb-3">
      ...
      <section>
        ...
        <pre className="bg-brand-charcoal rounded-lg px-4 py-3 text-sm text-brand-white font-mono overflow-x-auto">
          {`<img src="image.svg" alt="Image" />`}
        </pre>
        <p className="text-brand-white/90 text-sm leading-relaxed mt-3">
